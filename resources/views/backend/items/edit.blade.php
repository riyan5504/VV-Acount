...
@section('content')
    ...
    <div class="app-content-header">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0">Items Edit</h3>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        <li class="breadcrumb-item"><a href="{{ url('/dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Items Edit</li>
                    </ol>
                </div>
            </div>
            <!--end::Row-->
            ...
            <div class="row g-4">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary card-outline mb-4">
                        <!--begin::Form-->
                        <form action="{{ url('/items-entry/update/' . $item->id) }}" method="POST"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" value="{{ $item->pack_size }}" name="pack_size"
                                            class="form-control" id="pack_size" />
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label for="unit" class="form-label">Unit</label>
                                        <select name="unit" class="form-control" id="unit">                                            
                                            <option value="ml" @if ($item->unit == 'ml') selected @endif>ml</option>
                                            <option value="gm" @if ($item->unit == 'gm') selected @endif>gm</option>
                                        ...
                                        <select name="cat_id" class="form-control" id="cat_id" required>
                                            @foreach ($categories as $category)
                                                <option value="{{ $category->id }}"
                                                    @if ($item->cat_id == $category->id) selected @endif>{{ $category->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
